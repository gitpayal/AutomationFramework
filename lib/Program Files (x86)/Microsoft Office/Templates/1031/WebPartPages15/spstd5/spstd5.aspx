            	...
            	<td valign="top" width="100%" height="100%" style="margin:4px" >
					...
					<PlaceHolder id="MSO_ContentDiv" runat="server">
						...
						<table id="MSO_ContentTable" cellpadding="4" cellspacing="0" border="0" width="100%">
							...
							<tr>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" rowspan="4" valign="top" height="100%">
									<WebPartPages:WebPartZone runat="server" Title="loc:LeftColumn" ID="LeftColumn">
									</WebPartPages:WebPartZone>
								</td>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%">
									<WebPartPages:WebPartZone runat="server" Title="loc:Row1" ID="Row1" Orientation="Horizontal">
									</WebPartPages:WebPartZone>
								</td>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" rowspan="4" valign="top" height="100%">
							...
							<tr>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%">
									<WebPartPages:WebPartZone runat="server" Title="loc:Row2" ID="Row2" Orientation="Horizontal">
									</WebPartPages:WebPartZone>
								</td>
							</tr>
							<tr>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%">
									<WebPartPages:WebPartZone runat="server" Title="loc:Row3" ID="Row3" Orientation="Horizontal">
									</WebPartPages:WebPartZone>
								</td>
							</tr>
							<tr>
								<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%">
									<WebPartPages:WebPartZone runat="server" Title="loc:Row4" ID="Row4" Orientation="Horizontal">
									</WebPartPages:WebPartZone>
								</td>
							</tr>
							<tr>
